...
if __name__ == "__main__":
    try:
        async def test_validator():
            ...
            res1 = await validator.explain_similarity("What is a dinosaur")
...
# class TopicValidator:
#     """Validates if a query aligns with allowed topics using Qdrant for similarity search."""
...
#                                  "scripture", "Gospel", "rapture"],
#             "relationships": ["marriage", "family conflict", "parenting", "friendship"],
#             "people_of_God": ["Apostle", "Pastor", "Preacher", "Minister", "church", "envangelism", "ministry", "Gospel", "God"],
#             "Jews": ["Abraham", "Moses", "Judaism", "Covenant", "Jews", "Sabbath"],
#             "News": ["Nigeria", "News", "Politics", "President", "Policy", "Judiciary", "Bill", "Senator"],
#             "Greetings": ["Hello", "Hi", "Good day"]
#         }
#         self.blocklist = [
...
#         """Verify that the existing collection has the correct vector size."""
#         try:
...
#         """Create Qdrant collection and populate with topic embeddings."""
#         try:
#             # Create collection
...
#         """Calculate similarity scores against allowed topics in Qdrant."""
#         try:
#             query_embedding = self._get_query_embedding(query)

#             # Overall maximum similarity
#             overall_result = self.client.search(
#                 collection_name=self.collection_name,
#                 query_vector=query_embedding,
#                 limit=1
#             )
...
#     def add_topic_category(self, category: str, keywords: List[str]):
#         """Add new topic category and keywords to Qdrant at runtime."""
#         if not category or not keywords:
#             logger.error("Category and keywords cannot be empty")
#             raise ValueError("Category and keywords are required")
#         try:
...
#                 collection_name=self.collection_name).count
#             points = [
#                 models.PointStruct(
#                     id=current_count + i,
#                     vector=emb,
...
#         a = time.time()
#         validator = TopicValidator()
#         print(validator.explain_similarity("What is a dinosaur"))
#         print(validator.explain_similarity("When was Jesus Chrsit born?"))
#         b = time.time()
#         print(b-a)
#     except BaseException as e:
#         print(f"An Error Occured: {e}")
