...
# try:
#     answer = asyncio.run(rag_app.ainvoke(
#         {"question": "Who is the president of france", 'validators': {'validator': validator}}))
#     print(answer['generation'])
#     answer = asyncio.run(rag_app.ainvoke(
#         {"question": "Who is Apostle Uche Raymond", 'validators': {'validator': validator}}))
#     print(answer['generation'])
#     answer = asyncio.run(rag_app.ainvoke(
#         {"question": "Who is the Apostle Micheal Orokpo", 'validators': {'validator': validator}}))
#     print(answer['generation'])
#     answer = asyncio.run(rag_app.ainvoke(
#         {"question": "Who is the founder of Encounter Jesus International Ministries", 'validators': {'validator': validator}}))
#     print(answer['generation'])
# except Exception as e:
#     print(e)
